...
const db = mysql.createConnection({
  host: 'localhost',
  user: 'root',
  password: 'root', // กรอก password ของฐานข้อมูล
      ...
      const embed = {
        ...
        //fields: [
         // {
          ...
          //  value: '[Click here to watch the video](https://www.youtube.com/watch?v=your-video-id)' // ลิงก์ไปยัง YouTube หรือวิดีโออื่นๆ
         // }
        //]
        //
      };
